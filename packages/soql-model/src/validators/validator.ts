...
export const OPERATOR_LIKE_START = 'LIKE_START';
export const OPERATOR_LIKE_END = 'LIKE_END';
export const OPERATOR_LIKE_CONTAINS = 'LIKE_CONTAINS';
...
const allOperators = [
  ...
  { description: OPERATOR_LIKE, display: 'LIKE', types: LIKE_TYPES },
  { description: OPERATOR_LIKE_START, display: 'LIKE', types: LIKE_TYPES },
  { description: OPERATOR_LIKE_END, display: 'LIKE', types: LIKE_TYPES },
  { description: OPERATOR_LIKE_CONTAINS, display: 'LIKE', types: LIKE_TYPES },
